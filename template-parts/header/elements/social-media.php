<li class="social-media border-bottom">
	...
	<?php if ( get_theme_mod( 'instagram' ) ){ ?><a href="<?php echo get_theme_mod( 'instagram' ); ?>" class="icon-instagram"></a><?php } ?>
	<?php if ( get_theme_mod( 'pinterest' ) ){ ?><a href="<?php echo get_theme_mod( 'pinterest' ); ?>" class="icon-pinterest"></a><?php } ?>
</li>