...
function acf_form_head() {
	...
	if( acf_verify_nonce('acf_form') ) {
	    ...
	    if( acf_validate_save_post(true) ) {
	    	...
	    	$GLOBALS['acf_form'] = @json_decode($GLOBALS['acf_form']/* base64_decode($GLOBALS['acf_form']) */, true);
...
function acf_form( $args = array() ) {
	...
	<div class="acf-hidden">
		<?php acf_hidden_input(array( 'name' => '_acf_form', 'value' => json_encode($args)/* base64_encode(json_encode($args)) */ )); ?>
	</div>
