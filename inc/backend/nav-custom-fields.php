		...
		*/
		public static function _filter_walker( $walker ) {
			...
			if ( ! class_exists( $walker ) ) {
				require_once get_template_directory() . '/inc/backend/walker-nav-menu-edit.php';
			}
...
// Include the field needed
foreach ( glob( get_template_directory() . '/inc/backend/nav-fields/*.php' ) as $filename ){
