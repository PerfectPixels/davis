...
Kirki::add_field( 'pp_theme', array(
	...
	'section'     => 'header_builder',
	'default'     => array('social_icon', 'text_1'),
	'priority'    => 10,
	'multiple'    => 999,
...
Kirki::add_field( 'pp_theme', array(
	...
	'section'     => 'header_builder',
	'default'     => array('account', 'wishlist', 'cart'),
	'priority'    => 10,
	'multiple'    => 999,
	'choices'     => $header_options,
) );
...
Kirki::add_field( 'pp_theme', array(
	...
	'section'     => 'header_builder',
	'default'     => array('menu_icon', 'search_icon'),
	'priority'    => 10,
	'multiple'    => 999,
	'choices'     => $header_options,
) );
...
Kirki::add_field( 'pp_theme', array(
	...
	'section'     => 'header_builder',
	'default'     => array('search_icon', 'account', 'wishlist', 'cart'),
	'priority'    => 10,
	'multiple'    => 999,
	'choices'     => $header_options,
) );
