...
if ( $attachment_ids ) { ?>
    ...
    <div class="product_thumbs">
		<div id="thumb-slider" class="<?php echo $longer; ?>"  data-slick='{ "accessibility": true, "arrows": false, "dots": true, "focusOnSelect": true, "slidesToShow": <?php echo $thumb_to_show; ?>, "slidesToScroll": 1, "asNavFor": "#main-slider" }'>
