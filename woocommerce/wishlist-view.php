...
$remove_after_cart = get_option( 'yith_wcwl_remove_after_add_to_cart' ) == 'yes';
    ...
    <table class="shop_table cart wishlist_table" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo ( is_user_logged_in() ) ? esc_attr( $wishlist_meta['ID'] ) : '' ?>" data-token="<?php echo ( ! empty( $wishlist_meta['wishlist_token'] ) && is_user_logged_in() ) ? esc_attr( $wishlist_meta['wishlist_token'] ) : '' ?>">
        ...
        <tr>
            ...
            <th class="product-name">
                <span class="nobr"><?php echo apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Product', 'yith-woocommerce-wishlist' ) ) ?></span>
            </th>
            ...
            foreach( $wishlist_items as $item ) :
                ...
                if( $product !== false && $product->exists() ) :
                    ...
                    <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" class="product" data-row-id="<?php echo $item['prod_id'] ?>">
	                    ...
	                    <?php if( $show_last_column ): ?>
	                        <td class="product-add-to-cart <?php if ($remove_after_cart){ echo 'delete-once-added-cart'; } ?>">
                        ...
                        <td class="product-remove">
                            <div>
                                <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove remove_from_wishlist" data-toggle="tooltip" data-placement="top" title="<?php _e( 'Remove this product', 'yith-woocommerce-wishlist' ) ?>">&times;</a>
                            </div>
                        </td>
                        <?php endif; ?>
        ...
        <?php endif ?>
				...
				<?php if ( is_user_logged_in() && $is_user_owner || $show_cb ) : ?>
	        <tfoot>
	        <tr>
