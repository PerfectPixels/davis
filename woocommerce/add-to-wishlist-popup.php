...
<?php else: ?>
    ...
    <a href="#add_to_wishlist_popup_<?php echo $product_id ?>_<?php echo $unique_id?>" rel="nofollow" data-rel="prettyPhoto[add_to_wishlist_<?php echo $product_id ?>_<?php echo $unique_id?>]" data-product-id="<?php echo $product_id; ?>" data-product-type="<?php echo $product_type; ?>" class="<?php echo pp_get_option( 'wishlist_icon_outline' ) . ' open-pretty-photo ' . $link_classes; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $label; ?>"></a>
