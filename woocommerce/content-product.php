...
if ( $product->is_type( 'variable' ) ){ 
	...
	foreach ($available_variations as $variation){	
		...
		if ( get_field('variations_slider') === "yes" && get_theme_mod('shop_variations_slider') ){
			$exist = true;
...
if ( $product->is_type( 'variable' ) && get_field('variations_slider') === "no" || $product->is_type( 'variable' ) && !get_theme_mod('shop_variations_slider') ){
	...
	<li <?php post_class( $classes ); ?>>
		...
		<?php
			...
			if ( $product_style === 'product-style-1' ){
				...
				if ( $product->is_type( 'variable' ) && get_field('variations_slider') === "yes" && get_theme_mod('shop_variations_slider') && $product_style === 'product-style-1' ){
		...
		<section class="product-meta">	
			...
			<?php
				...
				if ($product->is_type( 'variable' )){
					Extras\tomo_variable_add_to_cart(false);
				}
